...
class Pagination
{
    ...
    public function __construct($total, $limitstart, $limit, $prefix = '', ?CMSApplication $cmsApplication = null)
    {
        ...
        $this->prefix = $prefix;
        $this->app = $cmsApplication ?: Factory::getApplication();
    ...
    protected function setUrlParamsFromRequest()
    {
        ...
        foreach ($router->getVars() as $key => $var) {
            ...
            $this->setAdditionalUrlParam($key, $inputFilter->clean($var, $filterMethod));
        }
    }
    ...
    {
        return LayoutHelper::render('joomla.pagination.link', ['data' => $paginationObject, 'active' => true]);
    }
    ...
    {
        return LayoutHelper::render('joomla.pagination.link', ['data' => $paginationObject, 'active' => false]);
    }
